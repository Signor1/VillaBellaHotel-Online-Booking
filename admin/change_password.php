...
<body id="page-top">
    ...
    <div id="wrapper">
                        ...
                        <div class="col-xl-10 col-lg-10">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-uppercase text-success">Admin Password Reset</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <?php
        ...
        <input type="password" class="form-control " id="password" placeholder="Confirm Your Password" name="confirmPassword" required/>    
        </div> 
                                    <?php endwhile; ?>
                                        <hr>
